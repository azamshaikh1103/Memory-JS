...
const list = () => {
    ...
    window.onload = () => {
        ...
        const resizeInit = (scrollBar, sbtab) => {
        
            let x, w;

            const rs_mouseHandler = (e) => {
                x = e.clientX;
    ...
    return (
        ...
        <div id="sbmain" className="flex w-[320px] min-w-1/6 z-10 mt-10 border-r-2 border-slate-300">
            <div id="sbtab" className="rounded-md w-full">
                ...
                <div id="sblist" className="flex flex-col overflow-y-scroll scrollbar-thin scrollbar-thumb-blue-100 h-[80vh] items-center px-2">
                    <ListCats />
                    <ListCats />
                    <ListCats />
                    <ListCats />
            ...
            <div id="scrollBar" className="bg-white w-[4px]">
                <div className="w-[4px] h-[86vh] hover:bg-slate-200 cursor-col-resize overflow-hidden"></div>    
            </div>     
        </div>
        </>
    );
