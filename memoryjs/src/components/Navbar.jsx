...
const navbar = () => {
    return (
        <>
            <nav id = "navigation-bar" className='w-full py-3 px-20 flex justify-between items-center border-b-2 border-slate-300'>
                <span id='mainlogo' className='font-mono text-3xl cursor-pointer'>MemoRy</span>
